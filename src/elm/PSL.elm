module PSL exposing (list)


list : List String
list =
    -- TODO store the output of this somewhere, it's kind of a lot of processing
    list_raw
        |> String.lines
        |> List.filter (\s -> not (String.startsWith "//" s || String.isEmpty s))


list_raw : String
list_raw =
    -- Downloaded 2024-03-03
